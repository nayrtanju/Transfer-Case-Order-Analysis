...
if st.session_state.get(
    ...
    with raw_results_tab:
        for order_value, curve_dataframe in (
            ...
            # =============================================================================
# SESSION STATE SAFETY AND FINAL APPLICATION CHECKS
# =============================================================================

def clear_analysis_session_state() -> None:
    """
    Remove stored analysis results from Streamlit session state.

    This prevents previous vehicle results from remaining visible after:
        - VIN change
    ...
    for state_key in analysis_state_keys:
...
def build_input_signature(
    ...
    """
    Create a compact signature representing the current analysis inputs.

    When this signature changes, old results are cleared automatically.
    """
